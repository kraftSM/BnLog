...
# BnLog
## Рабочая версия  итогового проекта C# of SkillFactory.(V1.4.00 от 2023-11-29 HW4  branch)
 - Реализация  требований HW4 (HW4  branch) в начальной стадии
## Текущая версия  итогового проекта C# of SkillFactory.(V1.3.1 от 2023-11-29 HW3  branch)
